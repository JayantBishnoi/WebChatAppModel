...
def ttieEncrypt(text, len, private_key):
    ...
    ttieImage.save(
        'C:/Users/w102/Desktop/Jayant/Jayant Apps/VSCode(Folders)/CyberSecurity Project/ttieOutput.png')
    ...
    for i in range(int(len/2)):
        ...
        for j in range(len):
            ...
            ttieImage.putpixel(
                (i, j), (pixels_value[0]+private_key, pixels_value[1]+private_key, pixels_value[2]+private_key))

    # Saving the image after two layers of Text to Image Encryption
    ttieImage.save(
        'C:/Users/w102/Desktop/Jayant/Jayant Apps/VSCode(Folders)/CyberSecurity Project/ttieOutput2.png')
    return ttieImage
...
wallpaper = PIL.Image.open(
    "C:/Users/w102/Desktop/Jayant/Jayant Apps/VSCode(Folders)/CyberSecurity Project/ttieOutput2.png")
# wallpaper1 = ttie_image.convert("RGB")
ttieDecryptedText = ttieDecrypt(wallpaper, no_pixels, 114)
